...
-Relational databases consist of multiple tables from which data can be accessed and arranged. SQL is the API used to access the database.

- [x] Why do tables need a `primary key`?

-Because that is what uniquely identifies each row in the table.
